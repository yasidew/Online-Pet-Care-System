...
<html lang="en">
  ...
  <body>
    ...
    <!-- body section -->
    <div class="aboutUsBodySection">
      <section>
        <img src="../images/pet4.png" alt="image">
      </section>

      <section>
        <h2>ABOUT VET ONLINE</h2>

        <h3>WHO WE ARE</h3>
        <p>Vet Online Animal hospital was established in order to provide a quality service to pet owners around the country to recieve all the pet related services right at their fingertips.Our centre is fully equipped with modern technology, professional qualified team of doctors, experienced technical personnel and professionally trained team of Veterinary Assistants and Dog Handlers to offer you a good service.<br>
          Our services include online Health Assistance, Pet Training tips, Pet community to discuss problems related to pets and customer can book groooming sessions and do the payment through the online payment portal.<br>
          With our Pet Boarding & Hospitalization facility we are helping the pet owners to plan their vacation without worrying about safety of their pet and would give hospitalized treatments when they are sick.<br>
          To provide a better service to the community, we can conduct mobile spay neuter programs in your neighborhood, private and government organizations. We have conducted large and small-scale sterilization and vaccinations campaigns around the country in collaboration with other animal welfare organizations in Sri Lanka throughout these years. With the field mobile unit our main aim is to safeguard your community from rabies and to reduce the increasing number of homeless puppies.</p>

        <h3>Our Vision</h3>

        <p>To deliver the most efficient online pet related services to our customers</p>

        <h3>Our Mission</h3>

        <p>To assist you and your four-legged friends with love, care and respect. At Vet Online we are dedicated and bound to provide the best service for all your pet’s needs.</p>
