...
<html lang="en">
  <head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="../css/petsitting.css" />
  ...
  <body>
    ...
    <div class="bodySection">
      ...
      <div class="slideshow-containerpetsit">
        <div class="mySlides fade">
          <img src="..\images\cr1.jpg" style="width:100%">
        </div>
        
        <div class="mySlides fade">
          <img src="..\images\cr2.jpg" style="width:100%">
        </div>
        
        <div class="mySlides fade">
          <img src="..\images\cr3.jpg" style="width:100%">
        </div>
      ...
      <br><br>
      <div class="petsitcontainer">
      <div class="card bg-dark" style="width: 400px; height: 350px; margin-left: 200px; margin-top: 50px; ">
        <div class="card-body text-light">
          <h1 class="card-title">Pet Sitting</h1>
          <br>
          <h3 class="card-text">Pet Sitting.Book Now</h3>
          <br>
          <h4 class="card-tesxt2">Our friendly Accredited staff is ready look after your pet while you are away. We will offer the best service to your pet. So book an appointment or call us on our hotline.</h4>
          <br><br>
        ...
        <div class="img-pet">
          <img src="../images/pet-banner.jpg">
        </div>
      </div> 
    </div>
  </div>
  </div>
  <script src="..\js\petsitting.js"></script>
